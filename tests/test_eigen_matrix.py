...
def test_dense_signature(doc):
    assert (
        doc(m.double_col)
        == """
        double_col(arg0: typing.Annotated[numpy.typing.NDArray[numpy.float32], "[m, 1]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float32], "[m, 1]"]
    """
    )
    assert (
        doc(m.double_row)
        == """
        double_row(arg0: typing.Annotated[numpy.typing.NDArray[numpy.float32], "[1, n]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float32], "[1, n]"]
    """
    )
    assert doc(m.double_complex) == (
        """
        double_complex(arg0: typing.Annotated[numpy.typing.NDArray[numpy.complex64], "[m, 1]"])"""
        """ -> typing.Annotated[numpy.typing.NDArray[numpy.complex64], "[m, 1]"]
    """
    )
    assert doc(m.double_mat_rm) == (
        """
        double_mat_rm(arg0: typing.Annotated[numpy.typing.NDArray[numpy.float32], "[m, n]"])"""
